  ...
  <div class="box">
    ...
    <div class="swipe">
          ...
          <div class="bottom">
            ...
            <div class="content">
              ...
              <div class="info">
                ...
                <div class="a">一节课</div>
                <div class="c">{{item.count}}人已看</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <template v-for="(item,index) in lists">
        <div class="item" @click="toSee({see:item.see.url})" :key="index">
          <div class="top">
            <div>{{item.see.title}}</div>
          </div>
          <div class="bottom" style="height:auto">
            <div class="title">{{item.see.content}}</div>
            <div class="content">
              <div>
                <div class="touxiang">
              ...
              <div class="info">
                <div class="b" style="font-size:.3rem">点击观看</div>
                <div class="a">
                  <br />
                  <!-- 一节课 -->
                </div>
                <div class="c" style="font-size:.24rem">{{item.see.count}}人已看</div>
              </div>
            </div>
          </div>
        </div>
