  ...
  <div>
    <!-- <div class="head">
      <div class="left" @click="()=>{window.history.back()}">
        <svg t="1597991759060" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="23483" width="48" height="48">
          <path d="M426.65984 170.65984q17.67424 0 30.16704 12.4928t12.4928 30.16704q0 18.00192-12.67712 30.33088l-225.66912 225.66912 665.00608 0q17.67424 0 30.16704 12.4928t12.4928 30.16704-12.4928 30.16704-30.16704 12.4928l-665.00608 0 225.66912 225.66912q12.67712 12.32896 12.67712 30.33088 0 17.67424-12.4928 30.16704t-30.16704 12.4928q-18.00192 0-30.33088-12.32896l-298.65984-298.65984q-12.32896-13.0048-12.32896-30.33088t12.32896-30.33088l298.65984-298.65984q12.67712-12.32896 30.33088-12.32896z" p-id="23484"></path>
        </svg>
      </div>
          ...
          <div class="item" @click="form.version='精英版'">
            ...
            <div>
              <span v-if="form.version == '精英版'">
                <svg t="1597990190000" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="22194" width="48" height="48">
                  <path d="M512 64a448 448 0 1 1 0 896A448 448 0 0 1 512 64z m0 64a384 384 0 1 0 0 768A384 384 0 0 0 512 128z m214.4 233.088a32 32 0 0 1 4.16 40.768l-3.648 4.48-249.856 256a32 32 0 0 1-39.04 5.312l-5.12-3.712-134.144-118.784a32 32 0 0 1 37.76-51.328l4.736 3.392L452.48 595.84l228.544-234.112a32 32 0 0 1 45.248-0.576z" p-id="22195" fill="#4bd964"></path>
                </svg>
              </span>
              <span v-else>
                <svg t="1597990268349" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="22615" width="48" height="48">
                  <path d="M512 912c-220.91 0-400-179.09-400-400s179.09-400 400-400 400 179.09 400 400-179.09 400-400 400z m0-60c187.78 0 340-152.22 340-340S699.78 172 512 172 172 324.22 172 512s152.22 340 340 340z" p-id="22616" fill="#bfbfbf"></path>
                </svg>
              </span>
            </div>
          </div>
...
-->
        <div class="item" @click="pay('微信')">
          <div>
            <svg t="1597989744509" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="16792" width="48" height="48">
              <path d="M396.8 627.2c-57.6 32-67.2-19.2-67.2-19.2l-70.4-166.4c-28.8-80 22.4-35.2 22.4-35.2s44.8 32 76.8 54.4c35.2 19.2 73.6 6.4 73.6 6.4l470.4-217.6C816 140.8 672 70.4 508.8 70.4c-265.6 0-480 188.8-480 419.2 0 134.4 70.4 252.8 182.4 329.6L192 934.4s-9.6 32 22.4 19.2c22.4-9.6 83.2-48 115.2-70.4 54.4 19.2 115.2 28.8 176 28.8 265.6 0 480-188.8 480-419.2 0-64-16-131.2-51.2-185.6-144 86.4-492.8 294.4-537.6 320z m0 0" p-id="16793" fill="#4bd964"></path>
            </svg>
            <span style="vertical-align: super;padding-left:.3rem;font-size:.28rem">微信支付</span>
          </div>
          <div>
...
export default {
  ...
  methods: {
    ...
    getCode() {
      ...
      window
        .fetch("http://www.guangyizhou.cn/studyapi/Payment/codes", {
          method: "post",
    ...
    setPay() {
      if (!this.form.title && !this.form.version) {
        alert("请选择版本");
        return;
      }
      ...
      if (this.form.title && !this.form.version && this.form.price) {
        alert("请选择预付版本");
        return;
      }
      if (!this.form.name) {
      ...
      // 微信内置浏览器使用微信支付
      if (this.form.type == "微信" && this.isUa == "微信") {
        this.wechatPay();
      }
      // 微信内置浏览器使用支付宝支付
      else if (this.form.type == "支付宝" && this.isUa == "微信")
        alert("如需使用微信支付，请在浏览器打开本页面！");
      // 其它浏览器使用微信支付
      else if (this.form.type == "微信" && this.isUa == "其它") this.wechat();
      // 其它浏览器使用支付宝支付
      else if (this.form.type == "支付宝" && this.isUa == "其它") this.alipay();
      // 支付宝内置浏览器使用微信支付
      else if (this.form.type == "微信" && this.isUa == "支付宝")
        alert("如需使用支付宝支付，请在浏览器打开本页面！");
      // 支付宝内置浏览器使用支付宝支付
      else if (this.form.type == "支付宝" && this.isUa == "支付宝")
        this.alipayPay();
    },
    wechatPay() {
      let form = new FormData();
      ...
      // 微信内置浏览器拉起微信支付
      window
        .fetch("http://www.guangyizhou.cn/studyapi/Payment/pay", {
          method: "post",
          withCredentials: "include",
          body: form
        })
